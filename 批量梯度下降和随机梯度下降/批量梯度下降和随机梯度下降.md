...
[批量梯度下降算法的寻参过程Gif图如下](https://github.com/KillEdision/machine-learning/blob/master/BGD.gif)  
...
[随机梯度下降算法的寻参过程Gif图如下](https://github.com/KillEdision/machine-learning/blob/master/SGD.gif)  
